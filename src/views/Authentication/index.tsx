            ...
            <div className='auth-card'>
                <div className='auth-card-box'>
                    <div className='auth-card-top'>
                        ...
                        <InputBox ref={passwordRef} label='패스워드' type={passwordType} placeholder='비밀번호를 입력해주세요.' error={error} value={password} icon={passwordButtonIcon} setValue={setPassword} onKeyDown={onPasswordKeyDownHandler} onButtonClick={onPasswordButtonClickHandler} />
                    </div>
