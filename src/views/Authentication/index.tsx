...
import SignUpReponseDto from 'apis/response/auth/sign-up.response.dto';
            ...
            <div className='auth-card'>
                <div className='auth-card-box'>
                    <div className='auth-card-top'>
                        ...
                        <InputBox ref={passwordRef} label='패스워드' type={passwordType} placeholder='비밀번호를 입력해주세요.' error={error} value={password} icon={passwordButtonIcon} onChange={onPasswordChangeHandler} onKeyDown={onPasswordKeyDownHandler} onButtonClick={onPasswordButtonClickHandler} />
                    </div>
            ...
            <div className='auth-card'>
                <div className='auth-card-box'>
                    <div className='auth-card-top'>
                        ...
                        {page === 1 && (
                            <>
                                <InputBox ref={emailRef} label='이메일 주소*' type='text' value={email} onChange={onEmailChangeHanlder} error={isEmailError} message={emailErrorMessage} placeholder='이메일 주소를 입력해주세요.' onKeyDown={onEmailKeyDownHandler} />
                ...
                <div className='auth-jumbotron-box'>
                    <div className='auth-jumbotron-contents'>
                        ...
                        <div className='auth-jumbotron-text-box'>
                            ...
                            <div className='auth-jumbotron-text'>{'MOONS BOARD 입니다.'}</div>
                        </div>
                    </div>
                </div>
